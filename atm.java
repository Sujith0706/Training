...
public class atm{ 
    ...
    static String name="sujith"; 
    static int password=0706;
    ...
    public static void admin(){ 
        ...
        int ad=0;
        if(name.equals(adminname) && adminpassword==4444){ 
            do { 
...
if(noOfCurrency[i]>0) 
        ...
        if(withdrawamount>balance){ 
            ...
            int noOfNote=0; 
            for(int j=3;j>=0;j--){ 
                while(withdrawamount>currency[j] && noOfCurrency[j]>0){ 
                    withdrawamount-=currency[j]; 
                    noOfCurrency[j]--; 
                    noOfNote++; 
                } 
            } 
